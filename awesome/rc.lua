...
awful.screen.connect_for_each_screen(function(s)
	...
	local hour_clock = awful.widget.textclock('<span color="#ffffff" font="Hasklug Nerd Font 14">%H</span>', 5)
	local minute_clock = awful.widget.textclock('<span color="#ffffff" font="Hasklug Nerd Font 14">%M</span>', 5)

	local tray_widget = wibox.container.rotate()
	tray_widget:set_direction("east")
	tray_widget:set_widget(wibox.widget.systray())
